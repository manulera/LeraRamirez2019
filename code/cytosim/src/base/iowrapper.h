...
public:
    ...
    /// Constructor
    Inputter() : FileWrapper(0)  { reset(); }
    
    /// Constructor
    Inputter(FILE * f, const char * path = 0) : FileWrapper(f, path)  { reset(); }
...
public:
    ...
    void    writeEndianess(const char[]);
