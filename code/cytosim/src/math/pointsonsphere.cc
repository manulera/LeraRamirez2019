...
//------------------------------------------------------------------------------
PointsOnSphere::PointsOnSphere(Random& rng)
: rng_(rng), num_points_(0), coord_(0)
{
}


PointsOnSphere::PointsOnSphere(Random& rng, unsigned nbp, real precision, unsigned mx_nb_iterations)
: rng_(rng), num_points_(0), coord_(0)
{
...
PointsOnSphere::PointsOnSphere(Random& rng, unsigned nbp)
: rng_(rng), num_points_(0), coord_(0)
{
...
unsigned PointsOnSphere::distributePoints(unsigned nbp, real precision, unsigned mx_nb_iterations)
{
    ...
    real * coord = new real[3*num_points_];
    real * force = new real[3*num_points_];
    ...
    {
        calculateForces(force, threshold);
