...
extern "C" {
    ...
    inline int lapack_ilaenv(int ispec, char *name, char *opts, int n1, int n2, int n3, int n4)
    {
    ...
    inline void lapack_xgbtrf(int M, int N, int KL, int KU, real* AB, int LDAB, int* IPIV, int* INFO)
    {
        FORTRAN(gbtrf)(&M, &N, &KL, &KU, AB, &LDAB, IPIV, INFO);
    }
    
    void FORTRAN(gbtf2)(int*, int*, int*, int*, real*, int*, int*, int*);
    inline void lapack_xgbtf2(int M, int N, int KL, int KU, real* AB, int LDAB, int* IPIV, int* INFO)
    {
        FORTRAN(gbtf2)(&M, &N, &KL, &KU, AB, &LDAB, IPIV, INFO);
    }
    
    void FORTRAN(gbtrs)(char *, int*, int*, int*, int*, const real*, int*, const int*, real*, int*, int*);
    inline void lapack_xgbtrs(char trans, int N, int KL, int KU, int NRHS, const real* AB, int LDAB, const int* IPIV, real* B, int LDB, int* INFO)
    {
    ...
    inline void lapack_xgetrf2(int M, int N, real* A, int LDA, int* IPIV, int* INFO)
    {
    ...
    inline void lapack_xgerfs(char trans, int N, int NRHS, const real* A, int LDA, const real* AF, int LDAF, const int* IPIV, real* B, int LDB, real* X, int LDX, real* FERR, real* BERR, real* WORK, int* IWORK, int* INFO)
    {
