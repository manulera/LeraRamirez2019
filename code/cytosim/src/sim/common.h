...
enum Confinement
{
    ...
    CONFINE_INSIDE      = 1,   ///< confine model points inside the Space
    CONFINE_OUTSIDE     = 2,   ///< confine model points outside the Space
    ...
    CONFINE_POINT0      = 14   ///< confine Point 0 of a Solid
};
