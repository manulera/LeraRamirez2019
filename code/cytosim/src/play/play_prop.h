...
public:
    ...
    /// list of report-strings accessible from play with 'i'
    std::string    report0, report1, report2, report3, report4;
    /// list of report-strings accessible from play with 'option-i'
    std::string    report5, report6, report7, report8, report9;
